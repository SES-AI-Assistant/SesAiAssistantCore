...
public class SES_AI_T_WATCH extends EntityBase {
    ...
    public String toString() {
        ...
        stringBuilder.append(",\"target_id\":\"" + this.targetId + "\"");
        stringBuilder.append(this.targetType != null ? (",\"target_type\":\"" + this.targetType.name() + "\"") : "");
        stringBuilder.append(",\"memo\":\"" + this.memo + "\"");
        stringBuilder.append(",\"register_date\":\"" + this.registerDate + "\"");
        stringBuilder.append(",\"register_user\":\"" + this.registerUser + "\"");
        stringBuilder.append(this.ttl != null ? (",\"ttl\":\"" + this.ttl.toString() + "\"") : "");
        stringBuilder.append("}");
