...
public class SES_AI_WEBAPP_M_USER extends EntityBase {
     ...
     * INSERTR文.
     */
    private final static String INSERT_SQL = "INSERT INTO SES_AI_WEBAPP_M_USER (user_id, user_name, company_id, role_cd, register_date, register_user) VALUES (?, ?, ?, ?, ?, ?)";
    /**
     * SELECT文.
     */
    private final static String SELECT_SQL = "SELECT user_id, user_name, company_id, role_cd, register_date, register_user FROM SES_AI_WEBAPP_M_USER WHERE user_id = ?";
    /**
     * UPDATE文.
     */
    private final static String UPDATE_SQL = "UPDATE SES_AI_WEBAPP_M_USER SET user_id = ?, user_name = ?, company_id = ?, role_cd = ?, register_date = ?, register_user = ? WHERE user_id = ?";
    /**
     * DELETE文.
     */
    ...
    public int insert(Connection connection) throws SQLException {
        ...
        preparedStatement.setTimestamp(5, this.registerDate == null ? null : this.registerDate.toTimestamp());
