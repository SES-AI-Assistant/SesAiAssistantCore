...
public class SES_AI_M_GROUP extends EntityBase {
     ...
     * INSERTR文.
     */
    private final static String INSERT_SQL = "INSERT INTO SES_AI_M_GROUP (from_group, group_name, register_date, register_user) VALUES (?, ?, ?, ?)";
    /**
     * SELECT文.
     */
    private final static String SELECT_SQL = "SELECT from_group, group_name, register_date, register_user FROM SES_AI_M_GROUP WHERE from_group = ?";
    /**
     * UPDATE文.
     */
    private final static String UPDATE_SQL = "UPDATE SES_AI_M_GROUP SET from_group = ?, group_name = ?, register_date = ?, register_user = ? WHERE from_group = ?";
    /**
     * DELETE文.
     */
    private final static String DELETE_SQL = "DELETE FROM SES_AI_M_GROUP WHERE from_group = ?";
    ...
    @Column(
        ...
        logicalName = "送信元グループ名")
    private String groupName;

    /**
     * コンストラクタ.
     */
    public SES_AI_M_GROUP() {
        super();
    }
    ...
    public int insert(Connection connection) throws SQLException {
        ...
        preparedStatement.setTimestamp(3, this.registerDate == null ? null : this.registerDate.toTimestamp());
