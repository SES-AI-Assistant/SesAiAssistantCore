 ...
 * Chat Post Message https://docs.slack.dev/reference/methods/chat.postMessage/
 */
@Data
@Builder
@NoArgsConstructor
...
public class SlackWebhookMessageEntity {
  ...
  @Builder.Default private List<SlackMessageBlock> blocks = new ArrayList<SlackMessageBlock>();
  ...
  public static class SlackMessageBlock {
    ...
    public static SlackMessageBlock 区切り線 =
        SlackMessageBlock.builder().type(BlockType.DIVIDER).build();
