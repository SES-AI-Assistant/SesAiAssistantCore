...
class SES_AI_API_USAGE_HISTORYLotTest {
  ...
  void fetchByProviderTest() {
    ...
    software.amazon.awssdk.core.pagination.sync.SdkIterable<SES_AI_API_USAGE_HISTORY> mockItems =
        mock(software.amazon.awssdk.core.pagination.sync.SdkIterable.class);
    doAnswer(
            invocation -> {
              java.util.function.Consumer<SES_AI_API_USAGE_HISTORY> consumer =
