...
class EntityLotBaseTests {
    ...
    static class TestEntity extends EntityBase {
        ...
        @Override
        public boolean updateByPk(Connection connection) throws SQLException { return false; }
        @Override
        public boolean deleteByPk(Connection connection) throws SQLException { return false; }
    }
