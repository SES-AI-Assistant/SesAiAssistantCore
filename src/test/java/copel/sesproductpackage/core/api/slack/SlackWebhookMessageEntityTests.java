...
class SlackWebhookMessageEntityTests {
    ...
    void testApiResponseEqualsThoroughly() throws Exception {
        SlackWebhookMessageEntity.SlackApiResponse res1 = new SlackWebhookMessageEntity.SlackApiResponse();
        SlackWebhookMessageEntity.SlackApiResponse res2 = new SlackWebhookMessageEntity.SlackApiResponse();
    ...
    void testConstructorsAndLombokExhaustive() throws Exception {
        ...
        SlackWebhookMessageEntity eFull = new SlackWebhookMessageEntity("channel", "text", "ts", blocks);
    ...
    void testBuildersExhaustive() {
        ...
        SlackWebhookMessageEntity e = SlackWebhookMessageEntity.builder()
                .channel("c")
                .text("t")
                .threadTs("ts")
                .blocks(new ArrayList<>())
        ...
        SlackMessageBlock b = SlackMessageBlock.builder()
                .type(BlockType.SECTION)
                .blockId("b")
                .text(null)
                .fields(null)
        ...
        TextObject t = TextObject.builder()
                .type(TextType.PLAIN_TEXT)
                .text("t")
                .build();
        assertNotNull(t);
        
        ImageAccessory a = ImageAccessory.builder()
                .type(AccessoryType.IMAGE)
                .imageUrl("u")
                .altText("a")
                .build();
